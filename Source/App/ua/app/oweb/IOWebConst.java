...
public interface IOWebConst extends IDirCoreConst {
	...
	public static final String	APP_NAME 				= "ouWeb";
	...
	public static final Message	PARAM_DESCRIPTION_MESSAGE	= new Message ("a10030000", "{0} [site.name]  [-list [name]] [-list match] [-edit.config] [-edit.shell] [-help]", APP_NAME);
    ...
    public static final ParamDef	PARAM_DEFS[]			= {
    	...
    	new ParamDef (PARAM_DIRECTORIES_SEARCH_MATCH2,	1, false,	new Message ("A10010007", 	"Same as -" + PARAM_DIRECTORIES_SEARCH_MATCH)),
