...
public interface IODocConst extends IDirCoreConst {
	...
	public static final String	APP_NAME 				= "oDoc";
	...
	public static final Message	PARAM_DESCRIPTION_MESSAGE	= new Message ("a10020000", "{0} [doc.name]  [-list [name]] [-match match] [-edit.config] [-edit.shell] [-help]", APP_NAME);
