...
public class OAppApp implements IApp {
	...
	public void displayData (List <StringList>	aliasStringListList) {
		...
		displayStringList.add ("App List");
	...
	public void init()  {
		...
		AppStore.appInfo.setProperty (IAppConst.APP_NAME,			IOAppConst.APP_NAME);
		...
		AppStore.paramDefPack				= IOAppConst.PARAM_DEF_PACK;
		...
		try {
			...
			try {
				...
				this.oDirComponent = new oDirComponent (IODirComponentConst.ODIR_TYPE_APP);
			}
